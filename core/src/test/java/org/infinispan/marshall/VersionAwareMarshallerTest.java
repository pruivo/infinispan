...
public class VersionAwareMarshallerTest extends AbstractInfinispanTest {
   ...
   public void testReplicableCommandsMarshalling() throws Exception {
      ...
      PutKeyValueCommand c5 = new PutKeyValueCommand("k", "v", false, null,
            new EmbeddedMetadata.Builder().build(), Collections.<Flag>emptySet(), AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
      marshallAndAssertEquality(c5);

      RemoveCommand c6 = new RemoveCommand("key", null, null, Collections.<Flag>emptySet(), AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
      ...
      InvalidateCommand c7 = new InvalidateCommand(null, null, CommandUUID.generateUUID(null), "key1", "key2");
      ...
      InvalidateCommand c71 = new InvalidateL1Command(null, null, null, Collections.<Flag>emptySet(), CommandUUID.generateUUID(null), "key1", "key2");
      ...
      ReplaceCommand c8 = new ReplaceCommand("key", "oldvalue", "newvalue",
            null, new EmbeddedMetadata.Builder().build(), Collections.EMPTY_SET, AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
      ...
      PutMapCommand c10 = new PutMapCommand(m1, null, new EmbeddedMetadata.Builder().build(), Collections.<Flag>emptySet(), CommandUUID.generateUUID(null));
   ...
   public void testMultiRpcCommand() throws Exception {
      ...
      PutKeyValueCommand c5 = new PutKeyValueCommand(
            "k", "v", false, null, new EmbeddedMetadata.Builder().build(), Collections.<Flag>emptySet(), AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
   ...
   public void testLongPutKeyValueCommand() throws Exception {
      PutKeyValueCommand c = new PutKeyValueCommand(
            ...
            false, null, new EmbeddedMetadata.Builder().build(), Collections.<Flag>emptySet(), AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
   ...
   public void testNestedNonSerializable() throws Exception {
      PutKeyValueCommand cmd = new PutKeyValueCommand(
            ...
            Collections.<Flag>emptySet(), AnyEquivalence.getInstance(), CommandUUID.generateUUID(null));
      try {
