...
public class StateProviderTest {
   ...
   public void test1() throws InterruptedException {
      ...
      cacheTopology = new CacheTopology(1, 1, ch1, ch1, ch1.getMembers(), true);
      ...
      log.debug("ch2: " + ch2);
      cacheTopology = new CacheTopology(2, 1, ch2, ch2, ch2.getMembers(), true);
      stateProvider.onTopologyUpdate(cacheTopology);
   ...
   public void test2() throws InterruptedException {
      ...
      cacheTopology = new CacheTopology(1, 1, ch1, ch1, ch2.getMembers(), true);
      stateProvider.onTopologyUpdate(cacheTopology);
