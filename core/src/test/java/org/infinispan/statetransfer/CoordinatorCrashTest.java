...
/**
 * Tests the coordinator crashes during the multiple phase of the state transfer.
 *
 * @author Pedro Ruivo
 * @since 8.0
 */
...
public class CoordinatorCrashTest extends MultipleCacheManagersTest {
   ...
   private CacheContainer addNode() {
      ...
      wrapGlobalComponent(cacheManager, InboundInvocationHandler.class, (wrapOn, current) -> new DiscardInboundInvocationHandler(current), true);
      return cacheManager;
   }
