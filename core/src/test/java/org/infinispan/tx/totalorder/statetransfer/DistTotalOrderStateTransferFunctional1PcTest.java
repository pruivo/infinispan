 ...
 * @since 5.2
 */
@Test (groups = "functional", testName = "tx.totalorder.statetransfer.DistTotalOrderStateTransferFunctional1PcTest", enabled = false)
public class DistTotalOrderStateTransferFunctional1PcTest extends StateTransferFunctionalTest {
   ...
   public DistTotalOrderStateTransferFunctional1PcTest() {
      this(CacheMode.DIST_SYNC, true, false);
   }

   public DistTotalOrderStateTransferFunctional1PcTest(CacheMode mode, boolean syncCommit, boolean writeSkew) {
      super("to-dist");
      this.mode = mode;
