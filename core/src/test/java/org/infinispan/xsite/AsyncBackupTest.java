...
public class AsyncBackupTest extends AbstractTwoSitesTest {
   ...
   private static ConfigurationBuilder getConfig(ConfigMode configMode) {
      ...
      switch (configMode) {
         ...
         case PESSIMISTIC_TX:
            ...
            break;
            //TODO! 1PC TotalOrder transaction don't work with cross-site
         case TOTAL_ORDER_TX_RR:
   ...
   private void testExpired(boolean lifespan) throws InterruptedException {
      SkipTestNG.skipIf(lonConfigMode == ConfigMode.TOTAL_ORDER_TX_RR, "TotalOrder doesn't work with expiration");
      SkipTestNG.skipIf(nycConfigMode == ConfigMode.TOTAL_ORDER_TX_RR, "TotalOrder doesn't work with expiration");
