...
@DefaultFactoryFor(classes = {CacheNotifier.class, CommandsFactory.class,
                              ...
                              RemoteValueRetrievedListener.class, InvocationContextFactory.class, KeyTrackAndCommitter.class,
...
public class EmptyConstructorNamedCacheFactory extends AbstractNamedCacheComponentFactory implements AutoInstantiableFactory {
   ...
   public <T> T construct(Class<T> componentType) {
      ...
      if (componentType.equals(ClusteringDependentLogic.class)) {
         ...
         } else if (componentType.equals(KeyTrackAndCommitter.class)) {
            return (T) new KeyTrackAndCommitter(configuration.dataContainer().keyEquivalence());
