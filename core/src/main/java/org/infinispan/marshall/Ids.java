...
public interface Ids {
   ...
   int VERSIONED_MORTAL_ENTRY = 77;
   int VERSIONED_TRANSIENT_ENTRY = 78;
   int VERSIONED_TRANSIENT_MORTAL_ENTRY = 79;
   int VERSIONED_IMMORTAL_VALUE = 80;
   ...
   int DATA_PLACEMENT_CONSISTENT_HASH_FACTORY = 98;
   int DATA_PLACEMENT_CONSISTENT_HASH = 99;

   //GMU
   int INTERNAL_GMU_NULL_ENTRY = 100;
   int INTERNAL_GMU_NULL_VALUE = 101;
   int INTERNAL_GMU_ENTRY = 102;
   int INTERNAL_GMU_VALUE = 103;
