...
import org.infinispan.dataplacement.ch.DRDConsistentHash;
...
public class ExternalizerTable implements ObjectTable {
   ...
   private void loadInternalMarshallables() {
      ...
      addInternalExternalizer(new ShadowTransactionInfo.Externalizer());
      ...
      addInternalExternalizer(new DataPlacementConsistentHash.Externalizer());
      addInternalExternalizer(new DataPlacementConsistentHashFactory.Externalizer());
      ...
      addInternalExternalizer(new DRDConsistentHash.Externalizer());
   }
