 ...
 * @since 8.0
 */
public class IracUpdateKeyCommand extends XSiteReplicateCommand implements InitializableCommand {
   ...
   public void init(ComponentRegistry componentRegistry, boolean isRemote) {
      Cache<Object, Object> cache = componentRegistry.getCache().running();
      backupReceiver = BackupReceiverRepositoryImpl.createBackupReceiver(cache);
   }
