...
public class CommandsFactoryImpl implements CommandsFactory {
   ...
   public void setupDependencies(DataContainer container, CacheNotifier notifier, Cache<Object, Object> cache,
                                 ...
                                 TimeService timeService, CommitLog commitLog, VersionGenerator versionGenerator,
   ...
   public GMUClusteredGetCommand buildGMUClusteredGetCommand(Object key, Set<Flag> flags, boolean acquireRemoteLock,
      ...
      return new GMUClusteredGetCommand(key, cacheName, flags, acquireRemoteLock, gtx,
                                        configuration.dataContainer().keyEquivalence(), txVersion, alreadyReadFromMask);
   }
