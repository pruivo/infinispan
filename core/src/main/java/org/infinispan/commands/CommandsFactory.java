...
public interface CommandsFactory {
   ...
   RemoveTombstoneCommand buildRemoveTombstoneCommand(int segment, long flags, int capacity);

   RemoveTombstoneBackupWriteCommand buildRemoveTombstoneBackupWriteCommand();
}
