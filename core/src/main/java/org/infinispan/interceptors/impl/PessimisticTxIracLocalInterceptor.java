 ...
 * @since 10.1
 */
public class PessimisticTxIracLocalInterceptor extends AbstractIracInterceptor {
   ...
   private void afterVisitDataWriteCommand(InvocationContext ctx, DataWriteCommand command, Object rv) {
      ...
      setMetadataForWrite(asLocalTxInvocationContext(ctx), command.getKey());
   }
   ...
   private void setMetadataForWrite(LocalTxInvocationContext ctx, Object key) {
