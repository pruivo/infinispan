...
public interface XSiteStateTransferManager {
   ...
   /**
    * It receives the notifications from local site when each node finish sending the state transfer to the remote
    * site.
    *
    ...
    */
   public void notifyStateTransferFinish(String siteName, Address node) throws Throwable;
    ...
    */
   public List<String> getRunningStateTransfer();
