...
public class XSiteAdminOperations {
   ...
   @ManagedOperation(displayName = "Push state to site",
                     description = "Pushes state to remote site from this site for all caches. " +
                           "The destination site will be bring back online",
                     name = "pushState")
   ...
   public final List<String> getRunningStateTransfer() {
      return stateTransferManager.getRunningStateTransfer();
   }
