 ...
 * <p>
 * When the response (or exception) is received, {@link IracResponseCompleted#onResponseCompleted(IracBatchSendResult, Collection)}
 * is invoked with the global result in {@link IracBatchSendResult} and a collection
