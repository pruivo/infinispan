...
public class OwnableReentrantPerEntryReadWriteLockContainer extends AbstractPerEntryLockContainer<OwnableRefCountingReentrantReadWriteLock> {
   ...
   @Override
   protected void unlockExclusive(OwnableRefCountingReentrantReadWriteLock toRelease, Object ctx) {
      toRelease.unlock(ctx);
   }

   @Override
   protected void unlockShare(OwnableRefCountingReentrantReadWriteLock toRelease, Object owner) {
