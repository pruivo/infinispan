...
public class CommandAckCollector {
    ...
    * @param topologyId the current topology id.
    */
   public void createPutMapCollector(CommandInvocationId id, Map<Address, Collection<Integer>> primary,
    ...
    */
   public void putMapPrimaryAck(CommandInvocationId id, Address from, Collection<Integer> segments,
         Map<Object, Object> returnValue, int topologyId) {
   ...
   private static class PutMapCollector implements Collector<Map<Object, Object>> {
      ...
      public PutMapCollector(CommandInvocationId id, Map<Address, Collection<Integer>> primary,
            Map<Address, Collection<Integer>> backups, int topologyId) {
         this.id = id;
         this.topologyId = topologyId;
      ...
      public synchronized void primaryAck(Map<Object, Object> returnValue, Address from, Collection<Integer> segments,
            int topologyId) {
         if (trace) {
