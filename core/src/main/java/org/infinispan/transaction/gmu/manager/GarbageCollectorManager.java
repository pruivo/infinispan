   ...
   private class VersionGarbageCollectorThread extends Thread {
      ...
      private void gc() {
         try {
            ...
            RpcOptions options = rpcManager.getRpcOptionsBuilder(ResponseMode.SYNCHRONOUS_IGNORE_LEAVERS, false).build();
            Map<Address, Response> responseMap = rpcManager.invokeRemotely(null, cmd, options);
            ...
            //step 4
            dataContainer.purgeOldValues(minimumLocalVersion);
   ...
   private class ViewGarbageCollectorThread extends Thread {
      ...
      private void gc() {
         try {
            ...
            RpcOptions options = rpcManager.getRpcOptionsBuilder(ResponseMode.SYNCHRONOUS_IGNORE_LEAVERS, false).build();
            Map<Address, Response> responseMap = rpcManager.invokeRemotely(null, request, options);
            ...
            rpcManager.invokeRemotely(null, control, rpcManager.getDefaultRpcOptions(false, false));
