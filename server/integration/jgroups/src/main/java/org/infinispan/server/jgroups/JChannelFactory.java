...
public class JChannelFactory implements ChannelFactory, ProtocolStackConfigurator {
    ...
    private void init(TP transport) {
        ...
        // TODO Uncomment when WFCORE-1127 is fixed and SocketBindingManager.UnnamedBindingRegistryImpl no longer throws IllegalStateException for unbound sockets
//        if (binding != null) {
